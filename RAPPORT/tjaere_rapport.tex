...
% Litteratur der kan henvises til - for at opdatere listen nedenfor skal bbl-filen slettes inden der compiles!
  ...
  \bibitem{matlab} MathWorks; \emph{MATLAB R2013b,www.mathworks.se/products/matlab/} 
  
  \bibitem{python}Python Software Foundation; \emph{Python v 2.7.5, www.python.org} 

  \bibitem{root}The ROOT Team; \emph{ROOT v 5.34.09, root.cern.ch/drupal} 
